...
:arrow_right: Please checkout [FLamby's 0.1.0 release](https://github.com/owkin/FLamby/releases/tag/0.1.0) which introduces changes to Fed-Camelyon16 benchmark as well as fixes some reproducibility issue across datasets.:arrow_left:
