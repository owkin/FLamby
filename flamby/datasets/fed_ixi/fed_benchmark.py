...
def main(args_cli):
    ...
    strategy_specific_hp_dicts.keys()
    # Strategies
    for num_updates in run_num_updates:
        for sname in strategy_specific_hp_dicts.keys():
            ...
            found_xps = found_xps.fillna(value=np.nan)
...
def init_data_loaders(
    ...
    if not pooled:
        training_dls = [
            dl(
                dataset(transform=train_transform, center=i, train=True, pooled=False),
                batch_size=batch_size,
                shuffle=True,
        ...
        test_dls = [
            dl(
                dataset(transform=val_transform, center=i, train=False, pooled=False),
        ...
        train_pooled = dl(
            dataset(transform=train_transform, train=True, pooled=True),
            batch_size=batch_size,
            shuffle=True,
            num_workers=num_workers,
            collate_fn=collate_fn,
        ...
        test_pooled = dl(
            dataset(transform=val_transform, train=False, pooled=True),
            batch_size=batch_size_test,
            shuffle=False,
            num_workers=num_workers,
            collate_fn=collate_fn,
