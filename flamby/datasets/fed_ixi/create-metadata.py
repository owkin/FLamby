import os
from utils import _get_id_from_filename, _extract_center_name_from_filename, _create_train_test_split
...
subjects = [subject for subject in os.listdir(subjects_dir) if os.path.isdir(os.path.join(subjects_dir, subject))]
images_centers = [_extract_center_name_from_filename(subject) for subject in subjects]

train_test_hh, train_test_guys, train_test_iop = _create_train_test_split(images_centers=images_centers)
