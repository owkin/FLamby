...
def main(slides_dir, features_dir, batch_size):
    ...
    batch_size : int
        The batch size for the resnet50's inference, depends on the capacity of the distant machine.
    """
    ...
    for sp in tqdm(slides_paths):
        path_to_feature = os.path.join(features_dir, slide_name + ".npy")
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            dataloader = DataLoader(dataset_from_slide, batch_size=batch_size, pin_memory=torch.cuda.is_available())
